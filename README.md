...
- 🤖 Worked in ASU's Machine Learning Lab, published three first-author papers in LLM alignment, post-training and ambiguity which collectively earned [30+ citations](https://scholar.google.com/citations?user=wVDeZtcAAAAJ&hl=en) within a year.
...
- 🫀 My Fav Projects are [Polymarket MCP](https://git.new/polymarket-mcp) (50,000+ users in 03/2026), [Canvas MCP](https://git.new/canvas-mcp) (2,000+ users in 03/2026) and [Alice](https://dub.sh/wonderland). 
